...
int main()
{
	...
	// Insert 12. Jadi daftar tertaut akan menjadi 6->NULL
	append(&head, 12);

	// Insert 8 pada awalnya.
	// Jadi daftar tertaut akan menjadi 5->11->NULL
	push(&head, 8);

	// Insert 4 pada awalnya. jadi
	// daftar tertaut akan menjadi 3->5->11->NULL
	push(&head, 4);

	// Insert 17 pada akhiran. jadi 
	// daftar tertaut akan menjadi 3->5->11->12->NULL
	append(&head, 17);

	// Insert 26 pada akhiran. jadi 
	// daftar tertaut akan menjadi 3->5->11->12->NULL
	append(&head, 26);
